...
Using localStorage for sessions was mostly just a workaround for having a completely static frontend, and results in a lot of duplicated code. We can switch from localStorage session keys to cookies, which needs a few changes to the backend and frontend.


% TODO Tailwind RTL gone
