...
\begin{figure}[H]
  \centering
  \subfloat{\includegraphics[height=5cm]{./media/development/frontend/localisation/ltr.png}}
  \subfloat{\includegraphics[height=5cm]{./media/development/frontend/localisation/rtl.png}}
...
\subsection{Register}
\paragraph{}
We can now create our register page. Using checks like the ones below, we can validate the user's input in real time.
...
{/if}
\end{minted}
This video shows our validation in action:
